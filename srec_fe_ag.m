function [vad, silence, features, wave_est, dif_mul, per80, per20,wiener_all,real_wiener_all] = srec_fe_ag(wave,cwave, dif_mul, step, step0, per80, per20,wiener_all, real_wiener_all)
alpha_n = 0.80;
alpha_s = 0.55;
...
for i = 1:n_frames;
    ...
    wreal = phipreal./phip; 
    % if ~flag 
        wiener_all(end+1) = {wiener};
        real_wiener_all(end+1) = {wreal};
